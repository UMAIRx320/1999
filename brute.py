...
for xd in range(1000):
    ...
    c = random.choice(['Orange Dive 73 Build/O11019; wv)'])
    p = '[FBAN/MessengerLite;FBAV/'
    y = ';FBPN/com.facebook.mlite;FBLC/en_US;FBBV/'
    x = 'FBCR/Airtel;FBMF/Facebook;Facebook/lge;FBDV/Orange Dive 73;FG;FBSV/9;FBCA'
    h = random.randrange(37, 325)
    f = random.randrange(1, 129)
    k = random.randrange(40, 150)
    z = random.randrange(11111111, 99999999)
    uaku = f'{a} {b}; {c} {p}{h}.0.0.{f}.{k}{y}{z};{x}'
    ugen.append(uaku)
    
    a = 'Dalvik/2.1.0 (Android'
    b = random.choice(['5.0', '6.0', '7.0', '8.1.0', '9', '10', '11', '12'])
    c = random.choice(['2201116SC Build/SKQ1.211006.001; wv)'])
    p = '[FBAN/MessengerLite;FBAV/'
    y = ';FBPN/com.facebook.mlite;FBLC/en_US;FBBV/'
    x = 'FBCR/Airtel;FBMF/Facebook;Facebook/xiaomi;FBDV/2201116SC;FG;FBSV/9;FBCA'
    h = random.randrange(37, 325)
    f = random.randrange(1, 129)
    k = random.randrange(40, 150)
    z = random.randrange(11111111, 99999999)
