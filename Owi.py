...
for xd in range(10000):
	...
	c=random.choice(['SM-A025V Build/SP1A.210812.016; wv)'])
	...
	b=random.choice(['5.0','6.0','7.0','8.1.0','9','10','11','12'])
	c=random.choice(['L-03K'])
	g='Build/PKQ1.190522.001)'
	p='[FBAN/MessengerLite;FBAV/141.0.0.2.117;FBPN/com.facebook.mlite;FBLC/en_US;FBBV/293513921;FBCR/Airtel;FBMF/Facebook;Facebook/lge;FBDV/L-03K;FBSV/9;FBCA'
	uaku=f'{a} {b}; {c} {g} {p}'
	ugen2.append(uaku)
